  ...
  return (
    ...
    <div className='w-full flex flex-col p-4 md:p-9 gap-4 bg-[#9d9a9d]'>
      <section className='w-full flex-center flex-wrap bg-[#b5b2b5] border-2 border-white rounded-md' id='Project_section'>
        ...
        <ProjectsBox imgLink='/Projects/Live-RoutineImg.jpg' imgName='Reacy-Project' iconLinks={['/Projects/icons/REACTJS.svg','/Projects/icons/TAILWINDCSS.svg','/Projects/icons/GIT.svg','/Projects/icons/GITHUB.svg','/Projects/icons/VERCEL.svg']} liveLink='https://live-routine-smalakar.vercel.app/' tag='#Live-Routine-Project' tagColor='#4a3ec9'/>
